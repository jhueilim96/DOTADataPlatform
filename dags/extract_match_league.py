...
@dag(
    dag_id='extract_match_from_league_v1', 
    default_args=default_args, 
    description='Get match records by leagues from OpenDota API', 
    start_date=datetime(2023, 9, 11), 
    schedule='@once'
) 
def extract_match_league():
    ...
    lookup_source_entity = PostgresOperator(
        ...
        postgres_conn_id='postgres_azure',
        do_xcom_push=True,
        params = {'source':'OpenDota', 'object':'leagues'}
    )
